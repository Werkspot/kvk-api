...
namespace Werkspot\KvkApi\Tests\Unit\Client\Adapter\Guzzle\Exception;
...
final class HandlerTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Werkspot\KvkApi\Client\Adapter\Guzzle\Exception\NotFoundException
     */
